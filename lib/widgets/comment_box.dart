      ...
      trailing: IconButton(
          ...
          onPressed: !isEnabled ? null : () async{
            ...
            await widget.commentsRef
              ...
              CustomFlushBar.customFlushBar(message: "comment added successfully ",type: FlushBarType.SUCCESS);
              ...
              controller.clear();
              CustomFlushBar.customFlushBar(message: "error adding comment ! ",type: FlushBarType.FAILURE);
            });
            controller.clear();
          }
      ),
